...
export default function Faq() {
    ...
    return (
        <section className="bg-white dark:bg-gray-950" ref={ref}>
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <motion.h2
                    ...
                    className="mb-8 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Frequently asked questions</motion.h2>
