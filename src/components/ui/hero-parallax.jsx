...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-96 w-[30rem] relative flex-shrink-0 bg-gray-950"
    >
      <Link
        href={product.link}
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-gray-950 pointer-events-none"></div>
